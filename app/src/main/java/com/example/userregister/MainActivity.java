...
//                Log.e("picture",str_picture);
                ...
                register(name, password,str_picture,image_send);
                break;
     ...
     * @param password
     */
    public void register(final String accountNumber,final String password,final String str_picture,final String imagePath){
        ...
        //请求地址
        String url = "http://94.191.87.62:8001/register/";    //注①
...
//                    这里判断的是图片地址,因为注册页面有一张默认图片,但是地址是null
                if (imagePath != null) {
